...
\begin{eqnarray*}
\start
  \ensuremath{\Varid{out}\comp [\mskip1.5mu \underline{\Conid{X}},\Varid{num\char95 ops}\mskip1.5mu]\mathrel{=}\Varid{id}}
%
\just\equiv{ Fusão+ (20) }
%
  \ensuremath{[\mskip1.5mu \Varid{out}\comp \underline{\Conid{X}},\Varid{out}\comp \Varid{num\char95 ops}\mskip1.5mu]\mathrel{=}\Varid{id}}
%
\just\equiv{ Universal+ (17) }
%
        \ensuremath{\begin{lcbr}\Varid{id}\comp i_1\mathrel{=}\Varid{out}\comp \underline{\Conid{X}}\\\Varid{id}\comp i_2\mathrel{=}\Varid{out}\comp \Varid{num\char95 ops}\end{lcbr}}
%
\just\equiv{ Natural-id (1) x2 }
%
        \ensuremath{\begin{lcbr}i_1\mathrel{=}\Varid{out}\comp \underline{\Conid{X}}\\i_2\mathrel{=}\Varid{out}\comp \Varid{num\char95 ops}\end{lcbr}}
%
\just\equiv{ def num\_ops }
%
        \ensuremath{\begin{lcbr}i_1\mathrel{=}\Varid{out}\comp \underline{\Conid{X}}\\i_2\mathrel{=}\Varid{out}\comp [\mskip1.5mu \Conid{N},\Varid{ops}\mskip1.5mu]\end{lcbr}}
%
\just\equiv{ Fusão+ (20) }
%
        \ensuremath{\begin{lcbr}i_1\mathrel{=}\Varid{out}\comp \underline{\Conid{X}}\\i_2\mathrel{=}[\mskip1.5mu \Varid{out}\comp \Conid{N},\Varid{out}\comp \Varid{ops}\mskip1.5mu]\end{lcbr}}
%
\just\equiv{ Universal+ (17) }
%
        \ensuremath{\begin{lcbr}i_1\mathrel{=}\Varid{out}\comp \underline{\Conid{X}}\\i_2\comp i_1\mathrel{=}\Varid{out}\comp \Conid{N}\end{lcbr}\;(i_2\comp i_1\mathrel{=}\Varid{out}\comp \Varid{ops})}
%
\just\equiv{ def ops }
%
        \ensuremath{\begin{lcbr}i_1\mathrel{=}\Varid{out}\comp \underline{\Conid{X}}\\i_2\comp i_1\mathrel{=}\Varid{out}\comp \Conid{N}\end{lcbr}\;(i_2\comp i_1\mathrel{=}\Varid{out}\comp [\mskip1.5mu \Varid{bin},\uncurry{\Conid{Un}}\mskip1.5mu])}
%
\just\equiv{ Fusão+ (20) }
%
        \ensuremath{\begin{lcbr}i_1\mathrel{=}\Varid{out}\comp \underline{\Conid{X}}\\i_2\comp i_1\mathrel{=}\Varid{out}\comp \Conid{N}\end{lcbr}\;(i_2\comp i_2\mathrel{=}[\mskip1.5mu \Varid{out}\comp \Varid{bin},\Varid{out}\comp \uncurry{\Conid{Un}}\mskip1.5mu])}
%
\just\equiv{ Universal+ (17) }
%
        \ensuremath{\begin{lcbr}i_1\mathrel{=}\Varid{out}\comp \underline{\Conid{X}}\\i_2\comp i_1\mathrel{=}\Varid{out}\comp \Conid{N}\end{lcbr}\;(i_2\comp i_2\comp i_1\mathrel{=}\Varid{out}\comp \Varid{bin})\;(i_2\comp i_2\comp i_2\mathrel{=}\Varid{out}\comp \uncurry{\Conid{Un}})}
%
\just\equiv{ Igualdade Extensional (71) x 4 }
%
        \ensuremath{\begin{lcbr}i_1\;\Varid{a}\mathrel{=}(\Varid{out}\comp \underline{\Conid{X}})\;\Varid{a}\\(i_2\comp i_1)\;\Varid{a}\mathrel{=}(\Varid{out}\comp \Conid{N})\;\Varid{a}\end{lcbr}\;((i_2\comp i_2\comp i_1)\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}(\Varid{out}\comp \Varid{bin})\;(\Varid{a},(\Varid{b},\Varid{c})))\;((i_2\comp i_2\comp i_2)\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{out}\comp \uncurry{\Conid{Un}})\;(\Varid{a},\Varid{b}))}
%
\just\equiv{ Universal+ (17) }
%
        \ensuremath{\begin{lcbr}i_1\;\Varid{a}\mathrel{=}(\Varid{out}\comp \underline{\Conid{X}})\;\Varid{a}\\(i_2\comp i_1)\;\Varid{a}\mathrel{=}(\Varid{out}\comp \Conid{N})\;\Varid{a}\end{lcbr}\;((i_2\comp i_2\comp i_1)\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}(\Varid{out}\comp \Varid{bin})\;(\Varid{a},(\Varid{b},\Varid{c})))\;((i_2\comp i_2\comp i_2)\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{out}\comp \uncurry{\Conid{Un}})\;(\Varid{a},\Varid{b}))}
...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{n}\;(i_1\;())\mathrel{=}\Varid{n}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{n}\;(i_2\;(i_2\;(i_2\;(\Conid{Negate},\Varid{a}))))\mathrel{=}\mathbin{-}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{n}\;(i_2\;(i_2\;(i_2\;(\Conid{E},\Varid{a}))))\mathrel{=}\Varid{expd}\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{clean}\mathbin{::}(\Conid{Eq}\;\Varid{a},\Conid{Num}\;\Varid{a})\Rightarrow \Conid{ExpAr}\;\Varid{a}\to ()+(\Varid{a}+((\Conid{BinOp},(\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a}))+(\Conid{UnOp},\Conid{ExpAr}\;\Varid{a}))){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Varid{op}\;\Varid{a}\;\Varid{b})\mathrel{=}\Varid{outExpAr}\;(\Conid{Bin}\;\Varid{op}\;\Varid{a}\;\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Varid{op}\;\Varid{a})\mathrel{=}\Varid{outExpAr}\;(\Conid{Un}\;\Varid{op}\;\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{X})\mathrel{=}\Varid{outExpAr}\;(\Conid{X}){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{gopt}\;\Varid{n}\mathrel{=}\Varid{g\char95 eval\char95 exp}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Conid{C}\;\Varid{n}\mathrel{=}(\mathrm{2}\;\Varid{n})\mathbin{!/}((\Varid{n}\mathbin{+}\mathrm{1})\mathbin{!*}(\Varid{n})\mathbin{!}){}\<[E]%
\\
\>[B]{}\Conid{C}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Conid{C}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{cima}\;\Varid{n}\mathbin{/}\Varid{baixo}\;\Varid{n}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{cima}\;\Varid{n}\mathrel{=}(\mathrm{2}\;\Varid{n})\mathbin{!}{}\<[E]%
\\
\>[B]{}\Varid{cima}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\mathrm{2}\;\Varid{n})\mathbin{!}\mathbin{*}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{2})\mathbin{*}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{cima}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{cima}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{cima}\;\Varid{n}\mathbin{*}\Varid{d}\;\Varid{n}\mathbin{*}\Varid{f}\;\Varid{n}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{d}\;\Varid{n}\mathrel{=}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{2}){}\<[E]%
\\
\>[B]{}\Varid{d}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{2})\mathbin{+}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{d}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{d}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{2}\mathbin{+}\Varid{d}\;\Varid{n}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{f}\;\Varid{n}\mathrel{=}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{f}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{1})\mathbin{+}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{f}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{f}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{2}\mathbin{+}\Varid{f}\;\Varid{n}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{baixo}\;\Varid{n}\mathrel{=}(\Varid{n}\mathbin{+}\mathrm{1})\mathbin{!*}(\Varid{n}\mathbin{!}){}\<[E]%
\\
\>[B]{}\Varid{baixo}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{n}\mathbin{+}\mathrm{1})\mathbin{!*}(\Varid{n}\mathbin{!})\mathbin{*}(\Varid{n}\mathbin{+}\mathrm{2})\mathbin{*}(\Varid{n}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{baixo}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{baixo}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{baixo}\;\Varid{n}\mathbin{*}\Varid{t}\;\Varid{n}\mathbin{*}\Varid{next}\;\Varid{n}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{t}\;\Varid{n}\mathrel{=}(\Varid{n}\mathbin{+}\mathrm{2}){}\<[E]%
\\
\>[B]{}\Varid{t}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{n}\mathbin{+}\mathrm{2})\mathbin{+}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{t}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{t}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{1}\mathbin{+}\Varid{t}\;\Varid{n}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{next}\;\Varid{n}\mathrel{=}(\Varid{n}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{next}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{n}\mathbin{+}\mathrm{1})\mathbin{+}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{next}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{next}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{1}\mathbin{+}\Varid{next}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;(\Varid{c},\Varid{cima},\Varid{baixo},\Varid{t},\Varid{next},\Varid{d},\Varid{f})\mathrel{=}(\Varid{cima}\div \Varid{baixo},(\Varid{mul}\;((\Varid{mul}\;(\Varid{cima},\Varid{d})),\Varid{f})),(\Varid{mul}\;((\Varid{mul}\;(\Varid{baixo},\Varid{t})),\Varid{next})),(\Varid{add}\;(\Varid{t},\mathrm{1})),(\Varid{add}\;(\Varid{next},\mathrm{1})),(\Varid{add}\;(\Varid{d},\mathrm{2})),(\Varid{add}\;(\Varid{f},\mathrm{2}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{1},\mathrm{1},\mathrm{2},\mathrm{1},\mathrm{2},\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prj}\;(\Varid{c},\Varid{cima},\Varid{baixo},\Varid{t},\Varid{next},\Varid{d},\Varid{f})\mathrel{=}\Varid{cima}\div \Varid{baixo}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
por forma a que
\begin{hscode}\SaveRestoreHook
...
\begin{eqnarray*}
\start
  \ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\Varid{cataL}\;\conj{\alt{\Varid{id}}{\Varid{alpha}}}{\alt{\underline{\mathrm{1}}}{\succ \comp (\p2\comp \p2)}}}
%
\just\equiv{ Lei da Troca (28) }
%
  \ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\Varid{cataL}\;\alt{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\conj{\Varid{alpha}}{\succ \comp (\p2\comp \p2)}}}
%
\qed
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{avg}\mathbin{::}[\mskip1.5mu \Conid{Double}\mskip1.5mu]\to \Conid{Double}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{outL}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}i_1\;\Varid{a};\Varid{outL}\;(\Varid{a}\mathbin{:}\Varid{l})\mathrel{=}i_2\;(\Varid{a},\Varid{l}){}\<[E]%
\\
\>[B]{}\Varid{intL}\mathrel{=}\alt{\Varid{singl}}{\Varid{cons}}{}\<[E]%
\\
\>[B]{}\Varid{cataL}\;\Varid{g}\mathrel{=}\Varid{g}\comp \Varid{fL}\;(\Varid{cataL}\;\Varid{g})\comp \Varid{outL}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{alpha}\mathbin{::}(\Conid{Fractional}\;\Varid{a},\Conid{Enum}\;\Varid{a},\Conid{Ord}\;\Varid{a})\Rightarrow (\Varid{a},(\Varid{a},\Varid{a}))\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{alpha}\;(\Varid{a},(\Varid{aver},\Varid{leng}))\mathrel{=}(\mathbin{/})\;((\mathbin{+})\;((\mathbin{*})\;\Varid{aver}\;\Varid{leng})\;\Varid{a})\;(\succ \;\Varid{leng}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{cataL}\;\alt{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\conj{\Varid{alpha}}{\succ \comp (\p2\comp \p2)}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\start
  \ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\llparenthesis\, \conj{\alt{\Varid{id}}{\Varid{beta}}}{\alt{\underline{\mathrm{1}}}{\Varid{mylength}}}\,\rrparenthesis}
%
\just\equiv{ Lei da Troca (28) }
%
  \ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\llparenthesis\, \alt{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\conj{\Varid{beta}}{\Varid{mylength}}}\,\rrparenthesis}
%
\qed
\end{eqnarray*}
...
\column{53}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{mylength}\mathbin{::}\Conid{Num}\;\Varid{a1}\Rightarrow ((\Varid{a2},\Varid{a1}),(\Varid{a3},\Varid{a1}))\to \Varid{a1}{}\<[E]%
\\
\>[B]{}\Varid{mylength}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\mathbin{+})\;(\Varid{b})\;(\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{beta}\mathbin{::}\Conid{Fractional}\;\Varid{a}\Rightarrow ((\Varid{a},\Varid{a}),(\Varid{a},\Varid{a}))\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{beta}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\mathbin{/})\;((\mathbin{+})\;((\mathbin{*})\;\Varid{a}\;\Varid{b})\;((\mathbin{*})\;\Varid{c}\;\Varid{d}))\;((\mathbin{+})\;\Varid{b}\;\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avgLTree}\mathbin{::}\Conid{Fractional}\;\Varid{a}\Rightarrow \mathsf{LTree}\;\Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{avgLTree}\mathrel{=}\p1\comp \llparenthesis\, \Varid{gene}\,\rrparenthesis\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{gene}\mathrel{=}\alt{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\conj{\Varid{beta}}{{}\<[53]%
\>[53]{}\Varid{mylength}}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
